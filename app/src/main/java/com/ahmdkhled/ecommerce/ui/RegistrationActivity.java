...
//        mEmailTxt = (AppCompatEditText) findViewById(R.id.email_edittext_reg);
//        mPasswordTxt = (AppCompatEditText) findViewById(R.id.password_edittext_reg);
//        mRegisterBtn = (AppCompatButton) findViewById(R.id.btn_signup);
