        ...
        next.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if(validateInput(fullname,emailaddress,phonenumber,Country,City,address1)){
                    ...
                    Address address=new Address(Country,City,123456,address1,"");
                ...
                .enqueue(new Callback<Checkout>() {
                    ...
                    public void onResponse(Call<Checkout> call, Response<Checkout> response) {
                        ...
                        if (checkout!=null){
                            ...
                            Toast.makeText(ChangeAddressActivity.this, "there is no address", Toast.LENGTH_SHORT).show();
                        }
                    }

                    @Override
                    public void onFailure(Call<Checkout> call, Throwable t) {
                        Log.d("CHECKOUTT",t.getMessage());
                        Toast.makeText(ChangeAddressActivity.this, "error getting address", Toast.LENGTH_SHORT).show();
                    }
                });
    }
